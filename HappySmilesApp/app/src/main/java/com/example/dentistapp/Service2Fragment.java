...
public class Service2Fragment extends BaseServiceFragment {
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        View rootView = inflater.inflate(R.layout.fragment_service2, container, false);
        ...
        scheduleButton.setOnClickListener(view -> {
            ...
            DateInfo info = new DateInfo(dateCalendar.getTimeInMillis(), "Procedimientos de obturación o llenado dental");
