...
public class Service1Fragment extends BaseServiceFragment {
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        View rootView = inflater.inflate(R.layout.fragment_service1, container, false);
        ...
        scheduleButton.setOnClickListener(view -> {
            ...
            DateInfo info = new DateInfo(dateCalendar.getTimeInMillis(), "Examen Bucodental Inicial");
