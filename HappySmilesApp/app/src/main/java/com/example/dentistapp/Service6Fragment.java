...
public class Service6Fragment extends BaseServiceFragment {
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        View rootView = inflater.inflate(R.layout.fragment_service6, container, false);
        ...
        scheduleButton.setOnClickListener(view -> {
            ...
            DateInfo info = new DateInfo(dateCalendar.getTimeInMillis(), "Tratamientos de blanqueamiento");
